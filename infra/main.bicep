...
var keyVaultName = tag('vault', resourceGroupName)
var eventHubServiceName = tag('eventhub', resourceGroupName)
var eventHubServicePrincipalName = tag('eventhub-identity', resourceGroupName)
var eventHubNamespaceId = tag('eventhub-namespace', resourceGroupName)
var deploymentId = guid(tag('deployment', resourceGroupName))
var eventHubConsumerGroupName = tag('consumer-group', resourceGroupName)
var functionPlanName = tag('function-plan', resourceGroupName)
var functionAppName = tag('function-app', resourceGroupName)
var storageName = guid(tag('storage', resourceGroupName))
var storageSecretName = tag('storage-connection-string', resourceGroupName)
